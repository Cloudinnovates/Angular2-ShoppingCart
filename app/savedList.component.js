System.register(['angular2/core', './shopping.service', './item.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, shopping_service_1, item_component_1;
    var SavedListComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            SavedListComponent = (function () {
                function SavedListComponent(_shoppingService) {
                ...
                SavedListComponent.prototype.ngOnInit = function () {
                    ...
                    this._shoppingService.userBasketObservable$.subscribe(function (resp) {
                        _this._itemsList = resp.savedListItems;
                        console.log("response");
                        console.log(_this._itemsList);
                    });
            ...
            exports_1("SavedListComponent", SavedListComponent);
        }
    }
});
